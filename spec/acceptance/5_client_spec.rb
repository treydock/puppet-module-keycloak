  ...
  context 'creates client' do
    ...
    it 'has created SAML client' do
      on hosts, '/opt/keycloak/bin/kcadm-wrapper.sh get clients/saml.foo.bar -r test' do
        ...
        expect(data['attributes']['saml.signing.certificate']).to eq('')
        expect(data['attributes']['saml.encryption.certificate']).to eq('')
        expect(data['attributes']['saml.signing.private.key']).to eq('')
      end
    end
  end
