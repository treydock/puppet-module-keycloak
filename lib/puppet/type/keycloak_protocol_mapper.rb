...
@example Add email protocol mapper to oidc-client client scope in realm test
  ...
  validate do
    ...
    if self[:protocol] == 'saml' && !['saml-group-membership-mapper', 'saml-user-property-mapper', 'saml-user-attribute-mapper', 'saml-role-list-mapper', 'saml-javascript-mapper'].include?(self[:type])
